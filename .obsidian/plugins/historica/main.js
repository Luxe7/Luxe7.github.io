      ...
      function parse8(input) {
        ...
        function peg$buildException(message, expected2, pos) {
          function cleanupExpected(expected3) {
            ...
            while (i3 < expected3.length) {
              if (expected3[i3 - 1] === expected3[i3]) {
                expected3.splice(i3, 1);
              } else {
                i3++;
              }
            }
          ...
          function buildMessage(expected3, found2) {
            function stringEscape(s3) {
              function hex(ch) {
                return ch.charCodeAt(0).toString(16).toUpperCase();
              }
              return s3.replace(/\\/g, "\\\\").replace(/"/g, '\\"').replace(/\x08/g, "\\b").replace(/\t/g, "\\t").replace(/\n/g, "\\n").replace(/\f/g, "\\f").replace(/\r/g, "\\r").replace(/[\x00-\x07\x0B\x0E\x0F]/g, function(ch) {
                return "\\x0" + hex(ch);
            ...
            var expectedDescs = new Array(expected3.length), expectedDesc, foundDesc, i3;
            for (i3 = 0; i3 < expected3.length; i3++) {
              expectedDescs[i3] = expected3[i3].description;
            }
        ...
        function peg$parseinline_table_assignment() {
          var s0, s1, s22, s3, s4, s5, s6, s7, s8, s9, s10;
                      ...
                      if (s8 !== peg$FAILED) {
                        ...
                        if (s9 !== peg$FAILED) {
                          ...
                          if (s10 !== peg$FAILED) {
                            ...
                            if (s11 !== peg$FAILED) {
                              s22 = [s22, s3, s4, s5, s6, s7, s8, s9, s10, s11];
                              s1 = s22;
                            } else {
                              peg$currPos = s1;
                              s1 = peg$c2;
                    ...
                    if (s7 !== peg$FAILED) {
                      ...
                      if (s8 !== peg$FAILED) {
                        ...
                        if (s9 !== peg$FAILED) {
                          ...
                          if (s10 !== peg$FAILED) {
                            s22 = [s22, s3, s4, s5, s6, s7, s8, s9, s10];
                            s1 = s22;
                          } else {
                            peg$currPos = s1;
                            s1 = peg$c2;
        ...
        function peg$parsetime_with_offset() {
          var s0, s1, s22, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16;
                                ...
                                if (s13 !== peg$FAILED) {
                                  ...
                                  if (s14 !== peg$FAILED) {
                                    ...
                                    if (s15 !== peg$FAILED) {
                                      ...
                                      if (s16 !== peg$FAILED) {
                                        s22 = [s22, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16];
                                        s1 = s22;
                                      } else {
                                        peg$currPos = s1;
                                        s1 = peg$c2;
  ...
  "node_modules/toml/lib/compiler.js"(exports, module2) {
    ...
    function compile(nodes) {
      ...
      function addTableArray(node) {
        ...
        assignedPaths = assignedPaths.filter(function(p5) {
          return p5.indexOf(quotedPath) !== 0;
        });
        assignedPaths.push(quotedPath);
      ...
      function deepRef(start2, keys, value, line, column) {
        ...
        for (var i3 = 0; i3 < keys.length; i3++) {
          ...
          } else if (i3 !== keys.length - 1 && valueAssignments.indexOf(traversedPath) > -1) {
            genError("Cannot redefine existing key '" + traversedPath + "'.", line, column);
          }
          ctx = ctx[key];
          if (ctx instanceof Array && ctx.length && i3 < keys.length - 1) {
  ...
  "node_modules/dayjs/plugin/quarterOfYear.js"(exports, module2) {
    !function(t3, n3) {
      ...
      return function(e2, i3) {
        var r2 = i3.prototype;
        r2.quarter = function(t4) {
          return this.$utils().u(t4) ? Math.ceil((this.month() + 1) / 3) : this.month(this.month() % 3 + 3 * (t4 - 1));
        };
        var s3 = r2.add;
        r2.add = function(e3, i4) {
          return e3 = Number(e3), this.$utils().p(i4) === n3 ? this.add(3 * e3, t3) : s3.bind(this)(e3, i4);
        };
        var u2 = r2.startOf;
        r2.startOf = function(e3, i4) {
          var r3 = this.$utils(), s4 = !!r3.u(i4) || i4;
          if (r3.p(e3) === n3) {
            var o2 = this.quarter() - 1;
            return s4 ? this.month(3 * o2).startOf(t3).startOf("day") : this.month(3 * o2 + 2).endOf(t3).endOf("day");
          }
          return u2.bind(this)(e3, i4);
        };
      };
    });
  }
...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js"(exports, module2) {
    !function(t3, e2) {
      "object" == typeof exports && "undefined" != typeof module2 ? module2.exports = e2() : "function" == typeof define && define.amd ? define(e2) : (t3 = "undefined" != typeof globalThis ? globalThis : t3 || self).dayjs = e2();
    }(exports, function() {
      "use strict";
      var t3 = 1e3, e2 = 6e4, n3 = 36e5, r2 = "millisecond", i3 = "second", s3 = "minute", u2 = "hour", a2 = "day", o2 = "week", c2 = "month", f3 = "quarter", h2 = "year", d2 = "date", l2 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t4) {
        var e3 = ["th", "st", "nd", "rd"], n4 = t4 % 100;
        return "[" + t4 + (e3[(n4 - 20) % 10] || e3[n4] || e3[0]) + "]";
      } }, m3 = function(t4, e3, n4) {
        var r3 = String(t4);
        return !r3 || r3.length >= e3 ? t4 : "" + Array(e3 + 1 - r3.length).join(n4) + t4;
      }, v2 = { s: m3, z: function(t4) {
        var e3 = -t4.utcOffset(), n4 = Math.abs(e3), r3 = Math.floor(n4 / 60), i4 = n4 % 60;
        return (e3 <= 0 ? "+" : "-") + m3(r3, 2, "0") + ":" + m3(i4, 2, "0");
      }, m: function t4(e3, n4) {
        if (e3.date() < n4.date())
          return -t4(n4, e3);
        var r3 = 12 * (n4.year() - e3.year()) + (n4.month() - e3.month()), i4 = e3.clone().add(r3, c2), s4 = n4 - i4 < 0, u3 = e3.clone().add(r3 + (s4 ? -1 : 1), c2);
        return +(-(r3 + (n4 - i4) / (s4 ? i4 - u3 : u3 - i4)) || 0);
      }, a: function(t4) {
        return t4 < 0 ? Math.ceil(t4) || 0 : Math.floor(t4);
      }, p: function(t4) {
        return { M: c2, y: h2, w: o2, d: a2, D: d2, h: u2, m: s3, s: i3, ms: r2, Q: f3 }[t4] || String(t4 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t4) {
        return void 0 === t4;
      } }, g4 = "en", D = {};
      D[g4] = M;
      var p5 = "$isDayjsObject", S = function(t4) {
        return t4 instanceof _2 || !(!t4 || !t4[p5]);
      }, w = function t4(e3, n4, r3) {
        var i4;
        if (!e3)
          return g4;
        if ("string" == typeof e3) {
      ...
      var _2 = function() {
        function M2(t4) {
          this.$L = w(t4.locale, null, true), this.parse(t4), this.$x = this.$x || t4.x || {}, this[p5] = true;
        }
        var m4 = M2.prototype;
        return m4.parse = function(t4) {
          this.$d = function(t5) {
            var e3 = t5.date, n4 = t5.utc;
            if (null === e3)
              return new Date(NaN);
            if (b.u(e3))
              return new Date();
            ...
            if ("string" == typeof e3 && !/Z$/i.test(e3)) {
              ...
              if (r3) {
                ...
                return n4 ? new Date(Date.UTC(r3[1], i4, r3[3] || 1, r3[4] || 0, r3[5] || 0, r3[6] || 0, s4)) : new Date(r3[1], i4, r3[3] || 1, r3[4] || 0, r3[5] || 0, r3[6] || 0, s4);
              }
            }
            return new Date(e3);
          }(t4), this.init();
        ...
        }, m4.isSame = function(t4, e3) {
          var n4 = O(t4);
          return this.startOf(e3) <= n4 && n4 <= this.endOf(e3);
        }, m4.isAfter = function(t4, e3) {
          return O(t4) < this.startOf(e3);
        }, m4.isBefore = function(t4, e3) {
          return this.endOf(e3) < O(t4);
        }, m4.$g = function(t4, e3, n4) {
          return b.u(t4) ? this[e3] : this.set(n4, t4);
        }, m4.unix = function() {
          return Math.floor(this.valueOf() / 1e3);
        }, m4.valueOf = function() {
          return this.$d.getTime();
        }, m4.startOf = function(t4, e3) {
          var n4 = this, r3 = !!b.u(e3) || e3, f4 = b.p(t4), l3 = function(t5, e4) {
            var i4 = b.w(n4.$u ? Date.UTC(n4.$y, e4, t5) : new Date(n4.$y, e4, t5), n4);
            return r3 ? i4 : i4.endOf(a2);
          }, $2 = function(t5, e4) {
            return b.w(n4.toDate()[t5].apply(n4.toDate("s"), (r3 ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e4)), n4);
          }, y2 = this.$W, M3 = this.$M, m5 = this.$D, v3 = "set" + (this.$u ? "UTC" : "");
          switch (f4) {
            case h2:
            ...
            case o2:
              var g5 = this.$locale().weekStart || 0, D2 = (y2 < g5 ? y2 + 7 : y2) - g5;
              return l3(r3 ? m5 - D2 : m5 + (6 - D2), M3);
            case a2:
            case d2:
              return $2(v3 + "Hours", 0);
            case u2:
        ...
        }, m4.$set = function(t4, e3) {
          var n4, o3 = b.p(t4), f4 = "set" + (this.$u ? "UTC" : ""), l3 = (n4 = {}, n4[a2] = f4 + "Date", n4[d2] = f4 + "Date", n4[c2] = f4 + "Month", n4[h2] = f4 + "FullYear", n4[u2] = f4 + "Hours", n4[s3] = f4 + "Minutes", n4[i3] = f4 + "Seconds", n4[r2] = f4 + "Milliseconds", n4)[o3], $2 = o3 === a2 ? this.$D + (e3 - this.$W) : e3;
          if (o3 === c2 || o3 === h2) {
          ...
          var d3, l3 = this;
          r3 = Number(r3);
          var $2 = b.p(f4), y2 = function(t4) {
            var e3 = O(l3);
            return b.w(e3.date(e3.date() + Math.round(t4 * r3)), l3);
          };
          if ($2 === c2)
          ...
          if ($2 === o2)
            return y2(7);
          var M3 = (d3 = {}, d3[s3] = e2, d3[u2] = n3, d3[i3] = t3, d3)[$2] || 1, m5 = this.$d.getTime() + r3 * M3;
          return b.w(m5, this);
        }, m4.subtract = function(t4, e3) {
          return this.add(-1 * t4, e3);
        }, m4.format = function(t4) {
          var e3 = this, n4 = this.$locale();
          if (!this.isValid())
            return n4.invalidDate || l2;
          var r3 = t4 || "YYYY-MM-DDTHH:mm:ssZ", i4 = b.z(this), s4 = this.$H, u3 = this.$m, a3 = this.$M, o3 = n4.weekdays, c3 = n4.months, f4 = n4.meridiem, h3 = function(t5, n5, i5, s5) {
            return t5 && (t5[n5] || t5(e3, r3)) || i5[n5].slice(0, s5);
          }, d3 = function(t5) {
            return b.s(s4 % 12 || 12, t5, "0");
          }, $2 = f4 || function(t5, e4, n5) {
            var r4 = t5 < 12 ? "AM" : "PM";
          ...
          var $2, y2 = this, M3 = b.p(d3), m5 = O(r3), v3 = (m5.utcOffset() - this.utcOffset()) * e2, g5 = this - m5, D2 = function() {
            return b.m(y2, m5);
          };
          switch (M3) {
            case h2:
          ...
          return D[this.$L];
        }, m4.locale = function(t4, e3) {
          if (!t4)
            return this.$L;
          var n4 = this.clone(), r3 = w(t4, e3, true);
      ...
      return O.prototype = k2, [["$ms", r2], ["$s", i3], ["$m", s3], ["$H", u2], ["$W", a2], ["$M", c2], ["$y", h2], ["$D", d2]].forEach(function(t4) {
        k2[t4[1]] = function(e3) {
  ...
  list(src) {
    ...
    if (cap) {
      ...
      while (src) {
        ...
        let line = cap[2].split("\n", 1)[0].replace(/^\t+/, (t3) => " ".repeat(3 * t3.length));
      ...
      for (let i3 = 0; i3 < list5.items.length; i3++) {
        this.lexer.state.top = false;
        list5.items[i3].tokens = this.lexer.blockTokens(list5.items[i3].text, []);
        if (!list5.loose) {
          const spacers = list5.items[i3].tokens.filter((t3) => t3.type === "space");
    ...
    for (let i3 = 0; i3 < tokens.length; i3++) {
      ...
      switch (token.type) {
        ...
        case "heading": {
          ...
          out2 += this.renderer.heading(this.parseInline(headingToken.tokens), headingToken.depth, unescape(this.parseInline(headingToken.tokens, this.textRenderer)));
          continue;
        }
        case "code": {
...
function extractStringBaseOnTag(tags, compromiseNLP, text) {
  for (const tag2 of tags) {
    const result = compromiseNLP(text).match(tag2).json();
    if (result.length != 0) {
      for (const r2 of result) {
        if (r2.text.includes(".") || r2.text.includes(",")) {
          continue;
        }
        return r2.text;
      }
...
async function GetTimelineDataFromDocumentArrayWithChrono(documents, customChrono, compromiseNLP, userfulInformationPatternTag, showSummaryTitle) {
  ...
  return timelineData.sort((a2, b) => {
    return a2.unixTime - b.unixTime;
  });
}
...
function FormatSentencesWithMarkElement(sen, el) {
  ...
  for (let i3 = 0; i3 < parts.length; i3++) {
    if (regex.test(parts[i3])) {
      el.createEl("historica-mark", {
        text: parts[i3].replace(/<historica-mark>/g, "").replace(/<\/historica-mark>/g, "")
      });
    } else {
      el.createEl("span", {
        text: parts[i3]
...
async function renderTimelineEntry(timelineData, style, el) {
  if (style === 1) {
    ...
    timelineData.map((entry) => {
      ...
      FormatSentencesWithMarkElement(entry.sentence, timelineEntryEl.createEl(
        "div",
    ...
    timelineData.map((entry) => {
      ...
      (0, import_obsidian.setIcon)(timelineIcon, "shell");
...
var View = class {
  ...
  fromText(input) {
    ...
    let document = methods17.one.tokenize.fromString(input, this.world);
...
var inputs = function(input, View2, world2) {
  ...
  if (typeof input === "string") {
    let document = methods17.one.tokenize.fromString(input, world2);
...
var knownOnes = function(list5, term, before2, after2) {
  for (let i3 = 0; i3 < list5.length; i3 += 1) {
    let o2 = list5[i3];
...
var contractions = (view) => {
  ...
  document.forEach((terms, n3) => {
    for (let i3 = terms.length - 1; i3 >= 0; i3 -= 1) {
      ...
      let words = knownOnes(list5, terms[i3], before2, after2);
...
var truncate = (list5, val) => {
  for (let i3 = list5.length - 1; i3 >= 0; i3 -= 1) {
    if (list5[i3] !== val) {
      list5 = list5.slice(0, i3 + 1);
      return list5;
    }
  }
  return list5;
...
var runMatch2 = function(maybeList, document, docCache, methods17, opts2) {
  ...
  for (let n3 = 0; n3 < maybeList.length; n3 += 1) {
    for (let i3 = 0; i3 < maybeList[n3].length; i3 += 1) {
      ...
      let res = methods17.one.match([document[n3]], m3);
...
var sweep = function(document, net3, methods17, opts2 = {}) {
  let docCache = methods17.one.cacheDoc(document);
  ...
  let results = runMatch_default(maybeList, document, docCache, methods17, opts2);
  return results;
};
...
var tagger = function(list5, document, world2) {
  const { model: model5, methods: methods17 } = world2;
...
var preTagger = function(view) {
  ...
  let document = methods17.two.quickSplit(docs);
  for (let n3 = 0; n3 < document.length; n3 += 1) {
    let terms = document[n3];
...
var postTagger = function(view) {
  ...
  let document = methods17.two.quickSplit(view.document);
...
var isSubordinate = function(m3) {
  ...
  for (let i3 = 0; i3 < list3.length; i3 += 1) {
    if (m3.has(list3[i3])) {
      return true;
    }
  }
...
var toPast2 = function(s3) {
  ...
  if (verbs.length > 1) {
    ...
    let list5 = s3.match("to #Verb+ #Conjunction #Verb").terms();
...
function getNthWeekdayOfMonth(year, month2, weekday, n3, hour = 0) {
  let dayOfMonth = 0;
  let i3 = 0;
  while (i3 < n3) {
    dayOfMonth++;
...
var ParsingResult = class {
  constructor(reference, index3, text, start2, end2) {
    this.reference = reference;
...
var AbstractParserWithWordBoundaryChecking = class {
  ...
  extract(context, match2) {
    var _a;
    const header = (_a = match2[1]) != null ? _a : "";
...
var AbstractTimeExpressionParser = class {
  ...
  extract(context, match2) {
    ...
    const index3 = match2.index + match2[1].length;
    const text = match2[0].substring(match2[1].length);
    const result = context.createParsingResult(index3, text, startComponents);
    match2.index += match2[0].length;
...
var SlashDateFormatParser = class {
  ...
  extract(context, match2) {
    ...
    const index3 = match2.index + match2[OPENING_GROUP].length;
    ...
    const result = context.createParsingResult(index3, text);
...
var Chrono = class {
  ...
  static executeParser(context, parser2) {
    ...
    while (match2) {
      const index3 = match2.index + originalText.length - remainingText.length;
      match2.index = index3;
...
var ParsingContext = class {
  ...
  createParsingResult(index3, textOrEndIndex, startComponents, endComponents) {
    const text = typeof textOrEndIndex === "string" ? textOrEndIndex : this.text.substring(index3, textOrEndIndex);
    ...
    return new ParsingResult(this.reference, index3, text, start2, end2);
  }
  debug(block2) {
...
var HistoricaPlugin = class extends import_obsidian2.Plugin {
  async onload() {
...
var HistoricaSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("Default Style").setDesc("Choose the default style for the timeline").addDropdown((dropdown) => {
    ...
    new import_obsidian2.Setting(containerEl).setName("Show Summary Title").setDesc("Show short title in the timeline, turn it off if you think it is not smart enough, and this will make this plugin run at fastest speed").addToggle((toggle) => {
